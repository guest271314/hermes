...
//CHECK-NEXT:    TryPutById        r1, r0, 1, "x"
//CHECK-NEXT:    TryGetById        r3, r1, 1, "foo"
//CHECK-NEXT:    TryGetById        r2, r1, 2, "x"
//CHECK-NEXT:    LoadConstUndefined r0
//CHECK-NEXT:    Call2             r0, r3, r0, r2
//CHECK-NEXT:    TryGetById        r0, r1, 2, "x"
...
//CHKNONSTRICT-NEXT:    TryGetById        r2, r1, 2, "x"
//CHKNONSTRICT-NEXT:    LoadConstUndefined r0
//CHKNONSTRICT-NEXT:    Call2             r0, r3, r0, r2
//CHKNONSTRICT-NEXT:    TryGetById        r0, r1, 2, "x"
